 ...
 */
import { StoreDailySnapshotsInputSchema, StorePriceSnapshotsInputSchema, StoreReservationsInputSchema, GetSnapshotsInputSchema, StoreMarketSnapshotInputSchema, } from "../schemas/snapshots.js";
 ...
 */
export function registerSnapshotTools(server, db) {
    ...
    server.registerTool("pricelabs_store_daily_snapshots", {
    ...
    server.registerTool("pricelabs_store_price_snapshots", {
    ...
    server.registerTool("pricelabs_store_reservations", {
    ...
    server.registerTool("pricelabs_get_snapshots", {
    ...
    server.registerTool("pricelabs_store_market_snapshot", {
