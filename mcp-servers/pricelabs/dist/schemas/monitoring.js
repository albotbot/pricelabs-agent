...
export const GetBookingPaceInputSchema = z.object({
    ...
    cutoff_days: z
        .array(z.number())
        .optional()
        .describe("Pace cutoff windows in days. Default: [7, 30, 60, 90]"),
});
...
export const LogActionInputSchema = z.object({
    ...
    listing_id: z
        .string()
        .optional()
        .describe("Listing ID if action is listing-specific. Omit for portfolio-level."),
    pms: z
        .string()
        .optional()
...
export const GetAuditLogInputSchema = z.object({
    ...
    start_date: z
        .string()
        .optional()
        .describe("Start date for range query (ISO datetime). Defaults to 7 days ago."),
    end_date: z
        .string()
        .optional()
        .describe("End date for range query (ISO datetime). Defaults to now."),
    limit: z
        .number()
        .optional()
