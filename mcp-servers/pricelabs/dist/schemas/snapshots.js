...
export const StoreDailySnapshotsInputSchema = z.object({
    ...
    snapshot_date: z
        .string()
        .optional()
        .describe("Override snapshot date (YYYY-MM-DD). Defaults to today."),
});
...
export const GetSnapshotsInputSchema = z.object({
    ...
    pms: z
        .string()
        .optional()
        .describe("Filter by PMS name. Required if listing_id is provided."),
    table: z
    ...
    start_date: z
        .string()
        .optional()
        .describe("Start date for range query (YYYY-MM-DD). Defaults to 30 days ago."),
    end_date: z
        .string()
        .optional()
        .describe("End date for range query (YYYY-MM-DD). Defaults to today."),
    limit: z
        .number()
        .optional()
...
export const StoreMarketSnapshotInputSchema = z.object({
    snapshots: z
        ...
        listings_used: z
            .number()
            .optional()
            .describe("Number of comparable listings in neighborhood"),
        p25_price: z
            .number()
            .optional()
