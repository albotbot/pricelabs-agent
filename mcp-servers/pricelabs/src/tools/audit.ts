...
export function registerAuditTools(
  ...
  server.registerTool(
    ...
    {
      description:
        "Record an agent action in the audit log. Call this after every significant action: generating reports, sending alerts, making recommendations, receiving approvals, executing changes.",
  ...
  server.registerTool(
    ...
    {
      description:
        "Retrieve audit trail entries. Filter by listing, action type, or date range. Use for accountability, debugging, and answering 'what changes have been made?' questions.",
