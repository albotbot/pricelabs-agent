...
export const SnapshotBeforeWriteInputSchema = z.object({
  ...
  start_date: z
    ...
    .optional()
    .describe(
      "Start date for override date range (YYYY-MM-DD). Required for set_overrides and delete_overrides.",
    ),
  end_date: z
    .string()
    .optional()
    .describe(
      "End date for override date range (YYYY-MM-DD). Required for set_overrides and delete_overrides.",
    ),
  channel: z
    .string()
    .optional()
...
/** Inferred type for SnapshotBeforeWriteInputSchema */
export type SnapshotBeforeWriteInput = z.infer<
  typeof SnapshotBeforeWriteInputSchema
>;
