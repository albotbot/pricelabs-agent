 ...
 */
export function ToolResponseSchema<T extends z.ZodTypeAny>(dataSchema: T) {
  return z.object({
...
export const ListingResponseSchema = z.object({
  ...
  occupancy_next_7: z.union([z.number(), z.string()]).nullable().optional().describe("Listing occupancy rate for the next 7 days (0-100, may be '43 %' string)"),
  occupancy_next_30: z.union([z.number(), z.string()]).nullable().optional().describe("Listing occupancy rate for the next 30 days (0-100, may be '43 %' string)"),
  occupancy_next_60: z.union([z.number(), z.string()]).nullable().optional().describe("Listing occupancy rate for the next 60 days (0-100, may be '43 %' string)"),
  occupancy_next_90: z.union([z.number(), z.string()]).nullable().optional().describe("Listing occupancy rate for the next 90 days (0-100, may be '43 %' string)"),
  market_occupancy_next_7: z.union([z.number(), z.string()]).nullable().optional().describe("Market average occupancy for the next 7 days (0-100, may be '43 %' string)"),
  market_occupancy_next_30: z.union([z.number(), z.string()]).nullable().optional().describe("Market average occupancy for the next 30 days (0-100, may be '43 %' string)"),
  market_occupancy_next_60: z.union([z.number(), z.string()]).nullable().optional().describe("Market average occupancy for the next 60 days (0-100, may be '43 %' string)"),
  market_occupancy_next_90: z.union([z.number(), z.string()]).nullable().optional().describe("Market average occupancy for the next 90 days (0-100, may be '43 %' string)"),
  revenue_past_7: z.union([z.number(), z.string()]).nullable().optional().describe("Revenue earned in the past 7 days (may be 'Fully Blocked' string)"),
  stly_revenue_past_7: z.union([z.number(), z.string()]).nullable().optional().describe("Same-time-last-year revenue for the past 7-day window (-1 if unavailable, may be string)"),
